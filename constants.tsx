...
export const SKILLS: Skill[] = [
  ...
  { name: "Gemini / OpenAI", icon: "🤖", category: 'tools' },
];
...
export const PROJECTS: Project[] = [
  {
    id: "1",
    title: "SariStorePOS",
    description: "Full-stack POS system for retail businesses featuring inventory management, barcode scanning, multi-payment methods, batch tracking, shift reconciliation, and real-time analytics. Built with React 19/TypeScript and Django REST Framework",
  ...
  },
  {
    ...
    description: "Full-stack RFID-based attendance solution featuring real-time tracking.",
  ...
  },
  {
    ...
    description: "A simple web app for consumers that compares products using its price and unit to get the best value",
